...
MENU = cv.imread(r"C:\Users\ASUS\OneDrive\Desktop\virtual_paint-main\virtual_paint-main\banner\menu.png")
if MENU is None:
    print("Failed to load menu.png. Check the file path or name.")
else:
    print("menu.png loaded successfully!")
